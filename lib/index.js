...
(function (factory) {
    ...
    exports.gen = exports.parse = void 0;
    exports.parse = function (url, hex) {
        if (hex === void 0) { hex = true; }
        return __awaiter(void 0, void 0, void 0, function () {
            var urlArr, hexArr;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, url.split('/')];
                    case 1:
                        urlArr = _a.sent();
                        return [4 /*yield*/, urlArr[urlArr.length - 1].split('-')];
                    case 2:
                        hexArr = _a.sent();
                        if (hex) {
                            return [2 /*return*/, hexArr.map(function (num) { return "#" + num; })];
                        }
                        else {
                            return [2 /*return*/, hexArr];
                        }
                        return [2 /*return*/];
                }
            });
    ...
    exports.gen = function (arr) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            // TODO: 🔧 Ensure arr isn't longer than 10
            try {
                return [2 /*return*/, arr.reduce(function (acc, curr, i) {
